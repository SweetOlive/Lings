...
//        0 <= fee < 5 * 10^4
        ...
        //System.out.println(maxProfit(b,3));
        int[] c = {1,4,6,2,8,3,10,14};// 13
        //System.out.println(maxProfit(c,3));
        int[] d = {4,5,2,4,3,3,1,2,5,4};// 4
        System.out.println(maxProfit(d,1));
        int[] e = {2,1,4,4,2,3,2,5,1,2};// 4
        System.out.println(maxProfit(e,1));
        int[] f = {1,2,1,5,3,5,5,4,1,5};// 11
        System.out.println(maxProfit(f,0));
