package com.gutan.servlet.Bill;
...
import com.gutan.service.bill.BillService;
import com.gutan.service.bill.BillServiceImpl;
...
public class BillServlet extends HttpServlet {
    ...
    private void getProviderlist(HttpServletRequest request, HttpServletResponse response)
        ...
        outPrintWriter.write(new Gson().toJson(providerList));
    ...
    private void delBill(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("application/json");
        PrintWriter outPrintWriter = response.getWriter();
        outPrintWriter.write(new Gson().toJson(resultMap));
        outPrintWriter.flush();
        outPrintWriter.close();
    }
